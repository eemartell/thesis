function [T, M, eu] = linmodel_gustetal(P,S,V)
...
G0(j,V.i) = -1;
%---------------------------------------------
j=j+1;  % [V eq. for lambda] (7) %%%remove
G0(j,V.lam) = 1;
G0(j,V.Vlam) = 1;
%---------------------------------------------
j=j+1;  % [Firm Pricing] (8)
%---------------------------------------------
G0(j,V.Vpi) = 1; %%% G0(j,V.w) = P.theta*S.w;
G0(j,V.epi) = -P.varphi*P.beta;
G0(j,V.w) = -P.theta*S.w;
%---------------------------------------------
j=j+1;  % [V eq. for pigap] (9) %%%remove
G0(j,V.Vpi) = 1;
G0(j,V.pi) = -P.varphi;
%---------------------------------------------
j=j+1;  % [Production Function] (10) 
%---------------------------------------------
G0(j,V.y) = 1;
G0(j,V.n) = -1;
%---------------------------------------------
