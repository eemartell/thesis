...
legstrs = {'Actual','NL-PF-5\%','PW-IF-0\%','PW-IF-0\%-stickyw'};
figure
...
p2(3).Color= 'g';p2(3).LineStyle = '--';
p2(4).Color= 'b';p2(4).LineStyle = '--';
...
%         title(['RMSE of ',V.desc{istate},' at ZLB (',V.plotnames{istate},')'],'Interpreter','latex','fontsize',10);
    ...
    set(leg1,'Position',op + [0,.015,0,0]);
