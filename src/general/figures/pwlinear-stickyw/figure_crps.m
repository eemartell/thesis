...
specs = {...
    ...
    '../../../Estimation-pwlinear-stickyw/states/','pwlinear','if','me0','Piecewise Linear, Inversion Filter, ME 0$\%$, Sticky Wages';...
    };
...
% close all
    ...
    legstrs = {'DGP','NL-PF-5\%','PW-IF-0\%','Lin-KF-0\%','PW-IF-0\%-Sticky-Wages'};
