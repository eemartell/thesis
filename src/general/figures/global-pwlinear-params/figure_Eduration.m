...
specs = {...
    ...
    '../../../global-pwlinear-params/me5/','global','pf','me5','NL-PF using PW-IF estimated parameters';...
    };
...
legstrs = {'Global-PF-5\%','PwLin-IF-0\%','Linear-KF-0\%','NL-PF/PW-IF-params'};
...
% close all
% Spec strings for legend
titles = {'PW-IF-0\%','NL-PF-5\%','Lin-KF-0\%','NL-PF/PW-IF-params'};
order = [2,1,3,4];
