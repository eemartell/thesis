...
%--------------------------------------------------------------------------
T = 21;
simstemp = textread(['../../../data-artificial-nocap/simulation_',dur,'.txt'],'%f');
sims{1} = reshape(simstemp,[T,V.nstate]);
...
nsims = 100;
nZLBpers = 6;
simstemp = textread(['../../../Estimation-global-nomiss/me5/simulation_',dur,'.txt'],'%f');
...
% PW-IF-0% simulations
%--------------------------------------------------------------------------
simstemp = textread(['../../../Estimation-pwlinear-nomiss/simulation_',dur,'.txt'],'%f');
simstemp = reshape(simstemp,[T,V.nstate,nsims,nZLBpers]);
simstemp(:,:,51:end,:) = [];
simstemp = reshape(simstemp,[T,V.nstate,(nsims/2)*nZLBpers]);
