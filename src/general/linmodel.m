...
G0(j,V.lam) = 1;
G0(j,V.a) = 1;
G0(j,V.c) = -1/(1-P.h/P.g);
G0(j,V.g) = -(P.h/P.g)/(1-P.h/P.g);
G1(j,V.c) = -(P.h/P.g)/(1-P.h/P.g);
%---------------------------------------------
j=j+1;  % [FOC Labor]
%---------------------------------------------
G0(j,V.w) = 1;
...
G0(j,V.cg) = -P.phiy*(1-P.rhoi);
G0(j,V.mp) = -1;
G1(j,V.in) = P.rhoi;
%---------------------------------------------
j=j+1;  % [Consumption Growth] 
%---------------------------------------------
G0(j,V.cg) = 1;
G0(j,V.g) = -1;
G0(j,V.c) = -1;
...
Psi(j,V.epsg) = P.sige;
%---------------------------------------------
j=j+1;  % [Preference Shock Process] 
%---------------------------------------------
G0(j,V.a) = 1;
G1(j,V.a) = P.rhoa;
Psi(j,V.epsa) = P.sigu;
