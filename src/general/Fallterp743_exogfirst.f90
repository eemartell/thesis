...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
    ...
    mwpointer x1i_pr,x2i_pr,x3i_pr
    mwpointer pf1_pr,pf2_pr,pf3_pr,pf4_pr
    mwpointer o1_pr,o2_pr,o3_pr,o4_pr
    
    ! Array information
	mwSize nx1,nx2,nx3,nx4,nx5,nx6,nx7,nodes,e1,e2,e3
	integer*4 myclassid
	double precision, allocatable, dimension(:) :: x1,x2,x3,x4,x5,x6,x7,x1i,x2i,x3i
    ...
    allocate(x2i(e2))
    allocate(x3i(e3))
    x1i_pr = mxGetPr(prhs(8))
    x2i_pr = mxGetPr(prhs(9))
    x3i_pr = mxGetPr(prhs(10))
    ...
    x5i = mxGetScalar(prhs(12))  
    x6i = mxGetScalar(prhs(13)) 
    x7i = mxGetScalar(prhs(14)) 
    ...
    allocate(o1(e1,e2,e3)) 
    allocate(o2(e1,e2,e3)) 
    allocate(o3(e1,e2,e3)) 
    allocate(o4(e1,e2,e3))
    plhs(1) = mxCreateNumericArray(3,[e1,e2,e3],myclassid,0)
    plhs(2) = mxCreateNumericArray(3,[e1,e2,e3],myclassid,0)
    plhs(3) = mxCreateNumericArray(3,[e1,e2,e3],myclassid,0)
    plhs(4) = mxCreateNumericArray(3,[e1,e2,e3],myclassid,0)
    ...
    call mxCopyReal8ToPtr(o1,o1_pr,e1*e2*e3)
    call mxCopyReal8ToPtr(o2,o2_pr,e1*e2*e3)
    call mxCopyReal8ToPtr(o3,o3_pr,e1*e2*e3)
    call mxCopyReal8ToPtr(o4,o4_pr,e1*e2*e3)
...
subroutine allterp(	o1,o2,o3,o4, &
    ...
    implicit none
    mwSize :: nx1,nx2,nx3,nx4,nx5,nx6,nx7,e1,e2,e3
    mwSize i1,i2,i3
    double precision x4i,x5i,x6i,x7i,fastrap
    ...
    double precision, dimension(e1) :: x1i
    double precision, dimension(e2) :: x2i
    double precision, dimension(e3) :: x3i
    double precision, dimension(e1,e2,e3) :: o1,o2,o3,o4

    ! Interpolate
    do i3 = 1,e3
      do i2 = 1,e2
        do i1 = 1,e1
          o1(i1,i2,i3) = fastrap(nx1,nx2,nx3,nx4,nx5,nx6,nx7,x1,x2,x3,x4,x5,x6,x7,x1i(i1),x2i(i2),x3i(i3),x4i,x5i,x6i,x7i,pf1)
          o2(i1,i2,i3) = fastrap(nx1,nx2,nx3,nx4,nx5,nx6,nx7,x1,x2,x3,x4,x5,x6,x7,x1i(i1),x2i(i2),x3i(i3),x4i,x5i,x6i,x7i,pf2)
          o3(i1,i2,i3) = fastrap(nx1,nx2,nx3,nx4,nx5,nx6,nx7,x1,x2,x3,x4,x5,x6,x7,x1i(i1),x2i(i2),x3i(i3),x4i,x5i,x6i,x7i,pf3)
          o4(i1,i2,i3) = fastrap(nx1,nx2,nx3,nx4,nx5,nx6,nx7,x1,x2,x3,x4,x5,x6,x7,x1i(i1),x2i(i2),x3i(i3),x4i,x5i,x6i,x7i,pf4)
        end do   
      end do
    end do
