...
P.s        = 0.0060;    % Average risk premium
...
P.phiy     = 0;%0.5; 	% Consumption growth response
P.h        = 0;%0.6;   	% Habit persistence
P.rhoa     = 0.85;      % Preference shock persistence
P.rhoi     = 0.75;      % Notional rate persistence
P.sige     = 0.0120;  	% Productivity growth shock std
P.sigu     = 0.0100;  	% Preference shock std
P.sigv     = 0.0020;  	% Interest rate shock std
