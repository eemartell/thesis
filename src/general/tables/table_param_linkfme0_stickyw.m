...
savename = 'table_param_linkfme0_stickyw.tex';

%Specifications to include: path, method, filter, measurement error, table
%label
specs = {...
    '../../Estimation-linear/me0/','linear','kf','me0','Linear, Kalman Filter, ME 0$\%$';...
    '../../Estimation-linear-stickyw/me0/','linear','kf','me0','Linear, Kalman Filter, ME 0$\%$, Sticky Wages';...
    };
