...
savename = 'table_param_linkfme5_stickyw.tex';

%Specifications to include: path, method, filter, measurement error, table
%label
specs = {...
    '../../Estimation-linear/me5/','linear','kf','me0','Linear, Kalman Filter, ME 5$\%$';...
    '../../Estimation-linear-stickyw/me5/','linear','kf','me0','Linear, Kalman Filter, ME 5$\%$, Sticky Wages';...
    };
