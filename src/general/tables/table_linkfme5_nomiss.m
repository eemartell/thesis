...
TcEnd{2,1} = '\caption{No Misspecification in the DGP. Median, $(5\%,95\%)$ credible sets and $[\operatorname{NRMSE}]$ of the posterior mean parameter estimates.}';
