...
savename = 'table_globalme.tex';
%Specifications to include: path, method, filter, measurement error, table
%label
specs = {...
    '../../Estimation-global/me2/','global','pf','me2','NL-PF-2$\%$'; ...     
    '../../Estimation-global/me5/','global','pf','me5','NL-PF-5$\%$';...   
    '../../Estimation-global/me10/','global','pf','me10','NL-PF-10$\%$';...
    };
...
TcEnd{2,1} = '\caption{Average, $(5,95)$ percentiles and $[\operatorname{NRMSE}]$ of the parameter estimates. $\Sigma$ is sum of the $\operatorname{NRMSE}$.}';
