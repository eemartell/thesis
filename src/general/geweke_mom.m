...
function [results_vec, results_struct] = geweke_mom(draws,taper_steps)
...
% Modified by Nate Throckmorton, August 2016
%   changed function name to geweke_mom
%   replaced Dynareoptions with taper_steps
