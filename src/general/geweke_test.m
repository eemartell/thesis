...
function results_struct = geweke_test(results1,results2,results_struct,taper_steps)
...
%   changed function name to geweke_test
%   replaced options with taper_steps

% for k=1:length(options.convergence.geweke.taper_steps)+1;
for k=1:length(taper_steps)+1;
