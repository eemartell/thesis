...
\tilde{V}_{\pi,t,k} = 1 - \theta + \theta\tilde{w}_{t,k} + \beta\varphi E_t[(\tilde{\lambda}_{t,k}/\tilde{\lambda}_{t+1})(\pi^{gap}_{t+1}-1)\pi^{gap}_{t+1}(\tilde{y}_{t+1}/\tilde{y}_{t,k})]
\end{gather}
for $k=1,2$ where $k=1$ corresponds to the non-ZLB regime and $k=2$ corresponds to the ZLB regime.
\begin{gather}
V_{l,t} = V_{l,t,1}I + V_{l,t,2}(1-I) 
\end{gather}
