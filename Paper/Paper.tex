...
\captionsetup{justification=centering}
  ...
  \begin{tabular}{l c c c c c c}
    ...
    \hline
  ART & 2401  & 76 & 21.6s & 78125 & 65 & 0h 15m 37.1s\\    
  GHLS & 2401  & 62 & 18.5s & 78125 & 1170 &  5h 32m 48.6s\\
  \hline
\end{tabular}
...
For the model without capital, the GHLS policy functions do not experience as pronounced a nonlinearity.
...
ZLB. The GHLS policy functions are smoother than the ART policy function with respect to both the average percent error from a linear plane and the RMSE.
...
\captionsetup{justification=centering}
  ...
  \begin{tabular}{l c c c c}
    ...
    \hline
    ART policy & 0.64407\% &0.0027327 $c$  units & 0.201367\% & 0.0029924 $l$ units \\    
  GHLS policy & 0.62694\% & 0.0026704 $c$ units & 0.732262\% & 0.010799 $l$ units \\
  \hline
\end{tabular}
...
The mean errors are similar, though the GHLS maximum errors are larger. The shapes of the errors are comparable.

For the model without capital, GHLS performs slightly better.
...
logarithms for the consumption Euler equation and the price Phillips curve. The mean and maximum Euler equations are comparable between algorithms, although GHLS has slightly smaller errors.
